...
// Cuando el usuario busca "mes completo" en avión, cada vuelo es una opción
// distinta del mismo destino, así que no deduplicamos por ciudad.
function shouldDedupe(rest) {
  return !(rest.transport === "plane" && rest.wholeMonth);
}
